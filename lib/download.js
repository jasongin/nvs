...
const ProgressBar = require('../deps/progress/index');
const { HttpProxyAgent } = require('../deps/http-proxy-agent/dist/index');
const { HttpsProxyAgent } = require('../deps/https-proxy-agent/dist/index');

let fs = require('fs');  // Non-const enables test mocking
let { http, https } = require('../deps/follow-redirects/index');  // Non-const enables test mocking
